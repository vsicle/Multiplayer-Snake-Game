...
public class WorldPanel : ScrollView, IDrawable
{
    ...
    /// <summary>
    /// Method that draws every snake in the world
    /// </summary>
    /// <param name="canvas">canvas to draw on</param>
    private void DrawAllSnakes(ICanvas canvas)
    {
        // for each snake
    ...
    /// <summary>
    /// method to draw all walls in the world
    /// </summary>
    /// <param name="canvas">canvas to draw on</param>
    private void DrawAllWalls(ICanvas canvas)
    {
        // Draw walls
        ...
        foreach (Wall wall in theWorld.walls.Values)
        {
            ...
            if (p1x != p2x)
            {
                // calculate how many walls need to be drawn
    ...
    /// <summary>
    /// draw every powerup in the world
    /// </summary>
    /// <param name="canvas">canvas to draw on</param>
    private void DrawAllPowerups(ICanvas canvas)
    {
