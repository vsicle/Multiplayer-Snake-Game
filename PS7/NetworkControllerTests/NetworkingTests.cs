...
public class NetworkTests
{
    ...
    public void TestSendMassiveMessage(bool clientSide)
    {
        SetupTestConnections(clientSide, out testListener, out testLocalSocketState, out testRemoteSocketState);
        ...
        string largeMessage = File.ReadAllText("ShrekScript.txt");

        Networking.Send(testLocalSocketState.TheSocket, largeMessage);
